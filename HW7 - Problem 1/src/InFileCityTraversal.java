...
/** A class to provide a conversion from <code>City</code> 
 *    data to a well-formated 
 *    <code>String</code> and a conversion from a 
 *    well-formatted <code>String</code>
 *    to an instance os a <code>City</code> */
class CityConverter {

    /** Convert <CODE>City</CODE> data to 
     * well structured string for file output*/
